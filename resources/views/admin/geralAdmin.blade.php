    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-2/3 w-full mx-auto overflow-auto">
            <div class="flex items-center justify-between mb-2">
                ...
                <a href="{{ route('admin.mostrarTelaDeNovoProduto') }}" class="flex ml-auto text-white bg-indigo-500 border-0 py-1.5 px-3 text-sm focus:outline-none hover:bg-indigo-600 rounded">Adicionar</a>
            </div>
            <table class="table-auto w-full text-left whitespace-no-wrap">
                ...
                <tr class="divide-y">
                    ...
                    <td class="px-4 py-3 text-sm text-right space-x-3 text-gray-900">
                        <a href="{{ route('admin.mostrarTelaDeActualizarProduto',$product->id ) }}" class="mt-3 text-indigo-500 inline-flex items-center">Editar</a>
